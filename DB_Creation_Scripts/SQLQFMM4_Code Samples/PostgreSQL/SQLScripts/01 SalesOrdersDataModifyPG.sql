...
INSERT INTO Customers
  (CustomerID, CustFirstName, CustLastName, CustStreetAddress, 
   CustCity, CustState, CustZipCode, CustAreaCode, 
   CustPhoneNumber)
  VALUES (1009, 'Andrew', 'Cencini', '507 - 20th Ave. E.
Apt. 2A', 
...
INSERT INTO Customers
  (CustomerID, CustFirstName, CustLastName, CustStreetAddress, 
   CustCity, CustState, CustZipCode, CustAreaCode, 
   CustPhoneNumber)
  VALUES (1028, 'Jeffrey', 'Tirekicker', '15622 NE 42nd Ct', 
   'Redmond', 'WA', '98052', 425, '555-9999');
/* Make sure the sequence is correct! */
SELECT setval('customers_customerid_seq', 1028);
...
INSERT INTO Employees
  (EmployeeID, EmpFirstName, EmpLastName, EmpStreetAddress, 
   EmpCity, EmpState, EmpZipCode, EmpAreaCode, EmpPhoneNumber)
  VALUES (709, 'Daffy', 'Dumbwit', '12345 Main St', 
   'Nowhere', 'TX', '77055', 515, '555-9998');
/* Make sure the sequence is correct! */
SELECT setval('employees_employeeid_seq', 709);
...
INSERT INTO Vendors
  (VendorID, VendName, VendStreetAddress, VendCity, 
   VendState, VendZipCode, VendPhoneNumber, VendFaxNumber, 
   VendWebPage, VendEMailAddress)
  VALUES (11, 'Astro Paper Products', '5639 N. Riverside', 
   'Chicago', 'IL', '60637', '(312) 555-9876', '(312) 555-9875', 
   NULL, NULL);
/* Make sure the sequence is correct! */
SELECT setval('vendors_vendorid_seq', 12);
...
INSERT INTO Categories
  ...
  VALUES (7, 'Scooters');
/* Make sure the sequence is correct! */
SELECT setval('categories_categoryid_seq', 7);
...
INSERT INTO Products
  ...
  VALUES (40, 'Ultimate Export 2G Car Rack', NULL, 
   180, 8, 5);
/* Make sure the sequence is correct! */
SELECT setval('products_productnumber_seq', 40);
...
INSERT INTO Orders
  (OrderNumber, OrderDate, ShipDate, CustomerID, EmployeeID, 
   OrderTotal)
  VALUES (291, '2017-10-29', '2017-12-02', 1025, 705, 
   5341.8);
INSERT INTO Orders
  (OrderNumber, OrderDate, ShipDate, CustomerID, EmployeeID, 
   OrderTotal)
...
INSERT INTO Orders
  (OrderNumber, OrderDate, ShipDate, CustomerID, EmployeeID, 
   OrderTotal)
  VALUES (371, '2017-11-13', '2017-12-16', 1009, 701, 
   816.74);
INSERT INTO Orders
  (OrderNumber, OrderDate, ShipDate, CustomerID, EmployeeID, 
   OrderTotal)
...
INSERT INTO Orders
  (OrderNumber, OrderDate, ShipDate, CustomerID, EmployeeID, 
   OrderTotal)
  VALUES (387, '2017-11-18', '2017-12-22', 1010, 708, 
   16587.5);
INSERT INTO Orders
  (OrderNumber, OrderDate, ShipDate, CustomerID, EmployeeID, 
   OrderTotal)
...
INSERT INTO Orders
  (OrderNumber, OrderDate, ShipDate, CustomerID, EmployeeID, 
   OrderTotal)
  VALUES (571, '2017-12-27', '2018-01-30', 1019, 704, 
   2423.8);
INSERT INTO Orders
  (OrderNumber, OrderDate, ShipDate, CustomerID, EmployeeID, 
   OrderTotal)
...
INSERT INTO Orders
  (OrderNumber, OrderDate, ShipDate, CustomerID, EmployeeID, 
   OrderTotal)
  VALUES (796, '2018-02-04', '2018-03-09', 1007, 703, 
   5695.5);
INSERT INTO Orders
  (OrderNumber, OrderDate, ShipDate, CustomerID, EmployeeID, 
   OrderTotal)
...
INSERT INTO Orders
  (OrderNumber, OrderDate, ShipDate, CustomerID, EmployeeID, 
   OrderTotal)
  VALUES (871, '2018-02-18', '2018-03-21', 1021, 708, 
   6386.96);
INSERT INTO Orders
  (OrderNumber, OrderDate, ShipDate, CustomerID, EmployeeID, 
   OrderTotal)
...
INSERT INTO Orders
  (OrderNumber, OrderDate, ShipDate, CustomerID, EmployeeID, 
   OrderTotal)
  VALUES (879, '2018-02-19', '2018-03-21', 1013, 705, 
   15745.14);
INSERT INTO Orders
  (OrderNumber, OrderDate, ShipDate, CustomerID, EmployeeID, 
   OrderTotal)
...
INSERT INTO Orders
  (OrderNumber, OrderDate, ShipDate, CustomerID, EmployeeID, 
   OrderTotal)
  VALUES (904, '2018-02-23', '2018-03-28', 1009, 708, 
   7673);
INSERT INTO Orders
  (OrderNumber, OrderDate, ShipDate, CustomerID, EmployeeID, 
   OrderTotal)
...
INSERT INTO Orders
  ...
  VALUES (944, '2018-03-01', '2018-03-04', 1020, 702, 
   7768.9);
/* Make sure the sequence is correct! */
SELECT setval('orders_ordernumber_seq', 944);
